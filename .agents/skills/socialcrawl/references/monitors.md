...
Monitors are **not** registry endpoints — they live at `/v1/monitors/*`, use methods beyond GET (POST/PATCH/DELETE), and are **not** counted in the 264-endpoint total. Auth is the same `x-api-key` header.
