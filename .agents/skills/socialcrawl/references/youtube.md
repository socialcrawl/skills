...
**Credit costs:** 18 standard (1 credit), 3 advanced (5), 1 premium (10), 7 custom (flat/metered) - the exact cost is in each endpoint heading below.
...
## GET /v1/youtube/channel/about - 60 credits (custom)
...
**Cost** 60 credits (custom) · **Cache** 900s (a hit costs 0 credits) · **Returns** Author · **Pagination** none
...
## GET /v1/youtube/search/advanced - 1-6 credits (request-shaped)
