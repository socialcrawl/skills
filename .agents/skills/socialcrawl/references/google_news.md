...
- `depth` (optional, integer) - Number of articles to retrieve (default 10, multiples of 10, max 100). No pagination beyond depth. · e.g. `20`
...
- `time_range` (optional, enum: hour | day | week | month | year) - Only return articles published within this window: hour, day, week, month, or year. Ignored when from/to is present. · e.g. `day`
