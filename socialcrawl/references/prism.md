...
## POST /v1/prism/comment-lookup - 2 credits (custom)

Re-check up to 25 known comments in one call — per-item results, failed items refunded.

**Cost** 2 credits (custom) · **Cache** not cached (every call is live and billed) · **Returns** Analytics · **Pagination** none
...
## POST /v1/prism/post-stats - 1 credit (custom)
...
## POST /v1/prism/profiles - 1 credit (custom)
